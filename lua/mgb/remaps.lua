...
--make pasting over something retain your copy
vim.keymap.set("x", "<leader>p", "\"_dP")
--copying (leader + y -> copying to system keyboard)
...
vim.keymap.set("n", "<C-f>", "<cmd>silent !tmux neww tmux-sessionizer<CR>") --create new tmux window for maybe a new project
